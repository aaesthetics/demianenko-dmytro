...
public final class UtilityClass {
    ...
    public static void GetStrArr (String incomingText) {
    	if(incomingText == null) {
    		System.out.println("Текст еще не введен.");
    		return;
    	}
    	String[] strArr = UtilityClass.Split(incomingText);
    	System.out.println("Количество введенных слов: " + strArr.length);
    	System.out.println("Массив введенных нами слов: ");
    	for(int i = 0; i < strArr.length; i++)
    	{
